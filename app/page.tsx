...
const PORTFOLIO_DATA = {
  ...
  proofs: [
    ...
    { competenceId: "business", subCompetenceId: "offre", projectTitle: "DIGITAG PRO — Modèle Économique", projectLink: "https://digitagpro.fr", folder: "digitag pro", file: "Tableaux_commissions.pdf", type: "pdf", label: "Pricing & Marges", caption: "Élaboration d'une structure de coûts solide. Définition des prix de vente, calcul du seuil de rentabilité et politique de commissionnement." },
    { competenceId: "business", subCompetenceId: "acquisition", projectTitle: "Acquisition B2C — Google Ads", folder: "site internet", file: "tableau example de mes depenses googles ads sur une boutique ecomerce total 2439.06.png", type: "image", label: "Pilotage Budgetaire (2.4k€)", caption: "Gestion concrète de l'acquisition payante (SEA). Allocation d'un budget de 2439€ ayant généré 318 549 impressions et 873 conversions de vente directes." },
    ...
    { competenceId: "business", subCompetenceId: "acquisition", projectTitle: "Boutique Mode — Stratégie d'Acquisition", folder: "site internet", file: "ga4-acquisition-organique.png", type: "image", label: "Fondamentaux SEO & Trafic Qualifié", caption: "Analyse GA4 sur une boutique de moins d'un an. Focus assumé sur l'acquisition payante (Ads) pour la rentabilité immédiate. Le travail de fond SEO (blogs, balises, copywriting) rapporte néanmoins ~10% du trafic avec un taux d'engagement record (>50%). Pour rappel technique, un engagement GA4 certifie une session de plus de 10 secondes, un événement de conversion ou au moins deux pages vues : la preuve formelle d'un trafic gratuit ultra-qualifié." },
    ...
    // --- TECH & IA ---
    { competenceId: "tech", subCompetenceId: "software", projectTitle: "REMAX — Ingénierie Logicielle (SaaS)", folder: "Remax", file: "screen du logiciel de gestions dees sinstres.png", type: "image", label: "Développement Full-Stack", caption: "Création d'un SaaS métier de gestion de sinistres. Front-end fluide en React.js, API robuste sous Node.js/Express connectée à une base PostgreSQL. Déploiement auto-hébergé via Docker et Coolify sur serveur Debian." },
