...
const PORTFOLIO_DATA = {
  ...
  proofs: [
    ...
    { competenceId: "produit", subCompetenceId: "branding", projectTitle: "CHROMA — Identite & Direction Artistique", folder: "chroma", file: "idee charte graphique 1.jpeg", type: "image", label: "Univers Visuel", caption: "Direction artistique et palette chromatique definissant l'identite premium de la marque." },
    ...
    { competenceId: "produit", subCompetenceId: "industrialisation", projectTitle: "DIGITAG MEMORY — Prototype → Installation reelle", projectLink: "https://digitagmemory.github.io/3D/", type: "canva", label: "Prototype 3D Interactif", caption: "Modélisation 3D interactive du coffret pour validation technique et design avant usinage.", isWebsite: true },
    ...
    { competenceId: "business", subCompetenceId: "offre", projectTitle: "DIGITAG PRO — Pricing B2B & Marges", projectLink: "https://digitagpro.fr", folder: "digitag pro", file: "Tableaux_commissions.pdf", type: "pdf", label: "Tableaux Commissions", caption: "Structuration du modèle economique et des marges commerciales." },
    ...
    { competenceId: "supply", subCompetenceId: "logistique", projectTitle: "DIGITAG PRO — Expedition internationale", folder: "digitag pro", file: "stock plaque lituanie.jpeg", type: "image", label: "Stock Lituanie", caption: "Gestion de stock délocalisé et preuve d'exportation de nos plaques NFC sur le marché lituanien." },
