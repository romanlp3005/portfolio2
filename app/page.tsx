...
const PORTFOLIO_DATA = {
  ...
  proofs: [
    ...
    // Regroupement de tous les projets académiques de Branding
    { competenceId: "produit", subCompetenceId: "branding", projectTitle: "Projets Academiques", folder: "academic", file: "Personas_detailles.pdf", type: "pdf", label: "Gioia Aperitivo - Personas", caption: "Construction strategique de profils clients realistes." },
    { competenceId: "produit", subCompetenceId: "branding", projectTitle: "Projets Academiques", folder: "academic", file: "Analyse_positionnement.pdf", type: "pdf", label: "Gioia Aperitivo - Analyse", caption: "Etude complète image de marque & axes d'amelioration." },
    { competenceId: "produit", subCompetenceId: "branding", projectTitle: "Projets Academiques", folder: "academic", file: "Segmentation_PRIZM_VALS.pdf", type: "pdf", label: "Eclat Naturel - Segmentation", caption: "Application methodologique avancee de segmentation marketing." },
    { competenceId: "produit", subCompetenceId: "branding", projectTitle: "Projets Academiques", folder: "academic", file: "Plan_strategique.pdf", type: "pdf", label: "Eclat Naturel - Stratégie", caption: "Definition d'une strategie coherente de lancement." },
    ...
    { competenceId: "produit", subCompetenceId: "branding", projectTitle: "Projets Academiques", projectLink: "https://www.canva.com/design/DAGWkEHzSIg/RrjDI0WuwxL3GZiBpqCgdg/view", type: "canva", label: "Textile - Etude de marche", caption: "Etude approfondie du marche textile et des tendances emergentes." },
    { competenceId: "produit", subCompetenceId: "branding", projectTitle: "Projets Academiques", projectLink: "https://www.canva.com/design/DAG-Uhz-9aM/MYAlyebATOSuqP7blmOlpw/view", type: "canva", label: "GioiA Aperitivo - Audit", caption: "Audit digital complet avec recommandations strategiques et axes d'optimisation." },
    { competenceId: "produit", subCompetenceId: "branding", projectTitle: "Projets Academiques", projectLink: "https://www.canva.com/design/DAG7xw_R1uM/wC9JJn3jyDkqACq-k9qEhQ/view", type: "canva", label: "Zazou - Rapport Digital", caption: "Plan strategique de developpement digital pour une entreprise locale." },
    ...
    { competenceId: "produit", subCompetenceId: "branding", projectTitle: "Projets Academiques", projectLink: "https://www.canva.com/design/DAGQ2agTW2o/roBnrOiz4h0_nZaATWEYXQ/view", type: "canva", label: "Graine Time - Design", caption: "Conception de l'univers de marque et des codes couleurs." },
